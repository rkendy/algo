...
public class CyclicRotation {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(check(new int[] { 3, 4, 1, 2 }, new int[] { 1, 2, 3, 4 }, 2));
        System.out.println(check(new int[] { 3, 4, 1, 2 }, new int[] { 1, 2, 3, 4 }, 6));
        System.out.println(check(new int[] {}, new int[] {}, 4));
    }

    public static boolean check(int[] expected, int[] input, int K) {
        return Arrays.equals(expected, new CyclicRotation().solution(input, K));
    }
}
