...
public class CountDiv {
    public int solution(int A, int B, int K) {
        int countUpToA = A / K; // numbers divisible by K from 1 to A
        int countUpToB = B / K; // numbers divisible by K from 1 to B
        return countUpToB - countUpToA + (A % K == 0 ? 1 : 0); // if A is divisible by K, add 1
    }
